...
video_path = '/net/per610a/export/das11f/plsang/vsd2013/video-rsz/';
#orig_video_path = video_path + 'AVIClipstest/';
orig_video_path = '/net/per610a/export/das11f/plsang/vsd2013/video/test2013/';
...
for idx in range(start_vid, end_vid):
	...
	command = 'ffmpeg -i ' + old_file + ' -s 320x' + str(new_h) + ' -aspect ' + str(w) + ':' + str(h) + ' ' + new_file
	print command
